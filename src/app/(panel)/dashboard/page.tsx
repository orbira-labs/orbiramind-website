            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              <Card padding="lg" accent="primary" variant="elevated">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Link href="/appointments" className="text-sm text-pro-primary hover:underline">Tümü</Link>
                </div>
                {loading ? (
              ...
              <Card padding="lg" accent="accent" variant="elevated">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <Link href="/tests" className="text-sm text-pro-primary hover:underline">Tümü</Link>
                </div>
                {loading ? (
                  <div className="space-y-3">
                    {[...Array(3)].map((_, i) => (
                  ...
                  <EmptyState icon={FlaskConical} title="Henüz analiz yok" description="İlk karakter analizinizi gönderin" actionLabel="Analiz Gönder" actionHref="/tests" />
                ) : (
                  <div className="space-y-2">
