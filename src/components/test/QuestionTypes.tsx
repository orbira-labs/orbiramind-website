...
export function ScaleQuestion({ question, value, labels, onAnswer, accentColor }: ScaleQuestionProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      {/* ========== MOBILE VIEW ========== */}
      <div className="md:hidden flex-1 flex flex-col justify-center px-4 py-4">
        <motion.h2
          initial={{ opacity: 0, y: 15 }}
          animate={{ opacity: 1, y: 0 }}
          className="text-lg font-bold text-gray-900 text-center leading-snug mb-5"
        >
          {question}
        </motion.h2>
          ...
          {[1, 2, 3, 4, 5].map((num, index) => {
            ...
            return (
              <motion.button
                ...
                className={clsx(
                  "w-full relative overflow-hidden rounded-xl border-2 transition-all duration-150",
                ...
                style={isSelected && accentColor ? { boxShadow: `0 6px 20px ${accentColor}35` } : undefined}
              >
                <div
                  className={clsx(
                ...
                <span className="text-base font-semibold pl-1.5">{label}</span>
      ...
      {/* ========== DESKTOP VIEW ========== */}
      <div className="hidden md:flex flex-1 flex-col justify-center px-6 py-8">
        <motion.h2
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="text-2xl font-bold text-gray-900 text-center leading-relaxed mb-12"
        >
          {question}
        </motion.h2>
          ...
          {[1, 2, 3, 4, 5].map((num, index) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-lg font-semibold pl-2">{label}</span>
      ...
      <div className="md:hidden flex-1 flex flex-col">
        <div className="flex-1 flex flex-col px-4 py-4 overflow-y-auto">
          <motion.h2
            initial={{ opacity: 0, y: 15 }}
            animate={{ opacity: 1, y: 0 }}
            className="text-lg font-bold text-gray-900 text-center leading-snug mb-2"
          >
            {question}
          </motion.h2>
              ...
              return (
                <motion.button
                  ...
                  className={clsx(
                    ...
                    isSelected
                      ? "bg-[#5B7B6A] border-[#5B7B6A] text-white shadow-sm shadow-[#5B7B6A]/20"
                      : "bg-white border-gray-200 text-gray-700"
                  )}
                >
                  {option.label}
        ...
        <div className="px-4 pb-4 pt-3 border-t border-gray-100 bg-white/90 backdrop-blur-sm">
          <motion.button
            ...
            className={clsx(
              "w-full min-h-[52px] rounded-xl font-semibold text-base transition-all duration-150",
              "flex items-center justify-center gap-2",
              "touch-manipulation active:scale-[0.97]",
              selectedValues.length > 0
                ? "bg-[#5B7B6A] text-white shadow-md shadow-[#5B7B6A]/20"
      ...
      <div className="hidden md:flex flex-1 flex-col">
        <div className="flex-1 flex flex-col px-6 py-8 overflow-y-auto">
          <motion.h2
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            className="text-2xl font-bold text-gray-900 text-center leading-relaxed mb-3"
          >
            {question}
          </motion.h2>
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="md:hidden flex-1 flex flex-col justify-center px-4 py-4">
        <motion.h2
          initial={{ opacity: 0, y: 15 }}
          animate={{ opacity: 1, y: 0 }}
          className="text-lg font-bold text-gray-900 text-center leading-snug mb-6"
        >
          {question}
        </motion.h2>
      ...
      <div className="md:hidden flex-1 flex flex-col">
        <div className="flex-1 flex flex-col justify-center px-4 py-4">
          <motion.h2
            initial={{ opacity: 0, y: 15 }}
            animate={{ opacity: 1, y: 0 }}
            className="text-lg font-bold text-gray-900 text-center leading-snug mb-8"
          >
            {question}
          </motion.h2>
          ...
          >
            <div className="flex items-baseline gap-2">
              <input
                ...
                autoComplete="off"
                className={clsx(
                  "w-28 text-center text-3xl font-bold text-gray-900",
                  "border-b-2 border-gray-300 focus:border-[#5B7B6A]",
          ...
          >
            <input
              ...
              className={clsx(
                ...
                "rounded-xl border-2 border-gray-200 focus:border-[#5B7B6A]",
