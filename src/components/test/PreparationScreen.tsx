    ...
    <div className="min-h-[100dvh] bg-gradient-to-br from-[#F5F9F7] via-white to-[#E8F0EC] flex items-center justify-center p-4 pt-safe pb-safe">
      ...
      >
        ...
        <motion.div
          ...
          className="w-16 sm:w-20 h-16 sm:h-20 bg-gradient-to-br from-[#5B7B6A] to-[#4A6A59] rounded-2xl flex items-center justify-center mx-auto mb-6 sm:mb-8 shadow-lg shadow-[#5B7B6A]/30"
        >
        ...
        <motion.h1
          ...
          className="text-xl sm:text-2xl font-bold text-gray-900 text-center mb-2 px-2"
        >
        ...
        <motion.p
          ...
          className="text-sm sm:text-base text-gray-500 text-center mb-6 sm:mb-8 px-2"
        >
        ...
        <motion.div
          ...
          className="bg-[#5B7B6A]/5 border border-[#5B7B6A]/15 rounded-2xl p-4 sm:p-5 mb-6 sm:mb-8"
        >
          <div className="flex gap-3 sm:gap-4">
            ...
            <div className="min-w-0">
              <h3 className="font-semibold text-[#5B7B6A] mb-1 text-sm sm:text-base">Önemli İpucu</h3>
