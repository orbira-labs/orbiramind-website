...
export function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-[var(--background)]">
      {/* ========== DESKTOP LAYOUT ========== */}
      <div className="desktop-only-flex min-h-screen">
        {/* Desktop: Branded Panel (Sol) */}
        <div className="w-[480px] xl:w-[520px] relative overflow-hidden flex">
          <div className="absolute inset-0 bg-gradient-to-br from-[#5B7B6A] via-[#4A6A59] to-[#3D5A4C]" />

          <div className="absolute inset-0 opacity-[0.07]">
            <svg width="100%" height="100%">
              <pattern id="dots-desktop" x="0" y="0" width="32" height="32" patternUnits="userSpaceOnUse">
                <circle cx="2" cy="2" r="1.5" fill="white" />
              </pattern>
              <rect width="100%" height="100%" fill="url(#dots-desktop)" />
            </svg>
          </div>
