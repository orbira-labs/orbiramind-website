...
export function DimensionRadar({ scores }: DimensionRadarProps) {
  ...
  return (
    <div className="space-y-3 max-w-[300px] mx-auto sm:max-w-none">
      <div className="flex items-center gap-3 mb-5">
        <div className="relative">
          <div className="h-9 w-9 sm:h-10 sm:w-10 rounded-xl bg-gradient-to-br from-[#5B7B6A] to-[#3D5A4A] flex items-center justify-center shadow-md">
        ...
        <div>
          <h3 className="text-base sm:text-lg font-bold text-gray-900">Boyut Bazlı Analiz</h3>
        ...
        {data.map((item, idx) => {
          ...
          return (
            ...
            >
              ...
              {/* Label */}
              <div className="w-20 sm:w-32 text-xs sm:text-sm text-gray-700 font-medium truncate">
                {item.label}
              </div>

              {/* Bar */}
              <div className="flex-1 h-6 sm:h-7 bg-gray-100 rounded-full overflow-hidden relative">
                <div
